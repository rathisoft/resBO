...
class UserProfileDialog extends ComponentDialog {
    ...
    async transportStep(step) {
        ...
        return await step.prompt(CHOICE_PROMPT, {
            prompt: 'Hello & Welcome To DiDiBot. Please select your Language to begin',
            choices: ChoiceFactory.toChoices(['English', 'Hindi', 'Spanish'])
        });
    }
    ...
    async summaryStep(step) {
        if (step.result) {
            ...
            let msg = `I have your Language as ${ userProfile.transport } and your name as ${ userProfile.name }`;
